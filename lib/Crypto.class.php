...
class Crypto{
	function aes256_encode($data, $key = CRYPTO_KEY, $iv = CRYPTO_IV){
	...
	function aes256_decode($data, $key = CRYPTO_KEY, $iv = CRYPTO_IV){
	...
	function salt_hash($password, $salt = CRYPTO_SALT){
