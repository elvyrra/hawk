<div id="manage-themes-page">
	...
	<!-- <div role="tabpanel" id="admin-themes-tabs"> -->
		<!-- <ul class="nav nav-tabs" role="tablist">
			...
			<li role="presentation"><a href="#admin-themes-menu-tab" role="tab" data-toggle="tab">{text key="admin.theme-tab-menu-title"}</a></li>			
		</ul>
		...
		<div class="tab-content">
			...
			<div role="tabpanel" class="tab-pane" id="admin-themes-menu-tab">{{ $tabs['menu'] }}</div>
		</div>	
	</div>
