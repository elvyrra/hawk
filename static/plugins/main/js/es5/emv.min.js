...
!function (e, t) {
    ...
    function e() {
        ...
        var t = ["string", "number", "boolean", "undefined", "symbol"];return t.indexOf(typeof e === "undefined" ? "undefined" : _typeof(e)) !== -1 || null === e || e instanceof Date;
    }function i(e) {
        return e.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, "\\$&");
    }
    ...
    a.directives = {}, a.directive("show", { update: function update(e, t, i) {
                    ...
                    switch (o) {case "checkbox":
                            ...
                            }case "date":
                            {
                                n instanceof Date || (n = new Date(n));var _t9 = n.getFullYear(),
                                    ...
                                    _r5 = n.getDate().toString().padStart(2, "0");e.value = _t9 + "-" + _i5 + "-" + _r5;break;
                            }case "file":
                            return;default:
            ...
            if ("select" !== e.nodeName.toLowerCase()) throw new n("options directive can be applied only on select tags");var r = i.$getDirectiveValue(t, e),
                ...
                (function () {
                    ...
                    }var t = e.value || r.$selected;e.innerHTML = "";var i = function i(_i6, n) {
        ...
        t.$before = [], t.previousElementSibling && (t.$before = [t.previousElementSibling], t.previousElementSibling.$before && (t.$before = t.$before.concat(t.previousElementSibling.$before))), t.$parent = t.parentNode;var n = t.innerHTML,
            ...
            if (document.documentElement.contains(e)) {
                var _n6 = i.$getDirectiveValue(t, e),
                    _r6 = i.$templates[_n6] || "";e.innerHTML = _r6;var _o2 = e.querySelectorAll("script");Array.from(_o2).forEach(function (e) {
                    if (e.innerText) {
    ...
    }), a.config = { attributePrefix: "e", delimiters: ["${", "}"] }, Object.defineProperty(a, "version", { value: "3.1.0", writable: !1 }), a.utils = { uid: function uid() {
            return e();
        ...
        if (e instanceof o) {
            ...
            var _t15 = f(e);return _t15.filter(function (t) {
